...
public class ProductFrontBuilder {
    ...
    public ProductFrontBuilder setImage(String imagePath){
        this.productFront.setImage(imagePath);
        return this;
    }
    public ProductFrontBuilder convertFromRequestToFront(RequestProduct product){
        ...
        this.productFront.setImage(product.getProductPhoto());
        return this;
    }
